...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-zinc-950 p-6 font-sans text-zinc-50 sm:p-20">
      {/* --- HERO / INPUT SECTION --- */}
      <div className="mt-20 mb-20 flex w-full max-w-xl flex-col items-start gap-8 sm:items-center sm:text-center">
        ...
        <div className="mt-4 flex w-full flex-col gap-3 sm:flex-row">
          <div className="relative flex-1">
            <Github className="absolute top-1/2 left-3 size-4 -translate-y-1/2 text-zinc-500" />
            <Input
              type="text"
              placeholder="https://github.com/username/repo"
              className="h-10 border-zinc-800 bg-zinc-950 pl-10 text-sm placeholder:text-zinc-600 focus-visible:ring-1 focus-visible:ring-zinc-700"
              value={githubUrl}
          ...
          <Button
            className="h-10 bg-zinc-100 px-6 text-zinc-950 hover:bg-zinc-200"
          ...
          <div className="flex flex-col">
            {deployments.map((deployment) => (
              <div
                ...
                className="group flex cursor-pointer items-center justify-between rounded-lg px-4 py-3 transition-all hover:bg-zinc-900/40"
              >
                <div className="flex min-w-0 items-center gap-3">
                  <Github className="size-3.5 text-zinc-600 transition-colors group-hover:text-zinc-400" />
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-7 w-7 text-zinc-600 opacity-0 transition-opacity group-hover:opacity-100 hover:bg-red-400/10 hover:text-red-400"
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            ...
                            and remove all associated build artifacts from S3.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel
